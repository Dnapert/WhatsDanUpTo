...
export default function toyPage() {
    ...
    return (
        ...
        <div className="flex flex-col items-center w-screen min-h-screen bg-slate-800">
            ...
            <div className=" bg-slate-500 rounded-md w-40 h-40  sm:w-60 sm:h-60 md:w-80 md:h-80 lg:w-96 lg:h-96 xl:w-96 xl:h-96"
                onMouseDown={(e) => {
                    console.log(e.pageX, e.pageY)
                    setCoords([...coords, { x: e.pageX - 5, y: e.pageY - 5 }])
                }}>
            ...
            <div className="flex flex-row items-center">
                <button className="p-2 rounded-md border-2 text-white z-1 " onClick={handleRemoveDot}> Undo </button>
                <button className="p-2 rounded-md m-1 border-2 text-white z-1" onClick={handleRedoDot}> Redo </button>
            </div>
            <div className="flex flex-col items-center w-1/2">
                <button className="p-2 rounded-md m-1 border-2 text-white z-1" onClick={() => setViewCode(!viewCode)}>View Code!</button>
